 ...
 * @author Cut Eka
 */
public class RiwayatTerapi extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(RiwayatTerapi.class.getName());

    public RiwayatTerapi() {
    initComponents();
    tampilData();
}
    ...
    private void initComponents() {
        ...
        jLabel1.setText("RIWAYAT TERAPI");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new RiwayatTerapi().setVisible(true));
    }
