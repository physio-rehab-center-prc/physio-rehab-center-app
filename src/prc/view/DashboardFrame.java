...
public class DashboardFrame extends JFrame {
    ...
    private String role; 
    private JButton btnMenuPasien;
    private JButton btnMenuJadwal;
    private JButton btnMenuRekamMedis;
    private JButton btnMenuTentang;

    
    public DashboardFrame(String roleAktor) {
        this.role = roleAktor; 
    ...
    private void initComponents() {
        ...
        menuPanel.add(btnMenuPasien);
        menuPanel.add(btnMenuJadwal);
        menuPanel.add(btnMenuRekamMedis);
        menuPanel.add(btnMenuTentang);
    ...
    private void aturMenuBerdasarkanRole() {
        ...
        switch (role) {
            case "Admin":
                btnMenuPasien.setEnabled(true);
                btnMenuJadwal.setEnabled(true);
                btnMenuRekamMedis.setEnabled(true);
                break;
            ...
            case "Farmasi":
                btnMenuPasien.setEnabled(false);     
                btnMenuJadwal.setEnabled(false);     
                btnMenuRekamMedis.setEnabled(false); 
                break;
            ...
            default:
                ...
                btnMenuJadwal.setEnabled(false);
                btnMenuRekamMedis.setEnabled(false);
                JOptionPane.showMessageDialog(this, "Aksi Ilegal: Peran pengguna tidak valid!", "Sistem Error", JOptionPane.ERROR_MESSAGE);
                break;
        }
    }
}