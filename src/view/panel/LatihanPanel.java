...
public class LatihanPanel extends JPanel {
    private SesiController sesiCtrl;
    private PasienController pasienCtrl;

    public LatihanPanel(SesiController sc, PasienController pc) {
        this.sesiCtrl = sc;
        this.pasienCtrl = pc;
    ...
    private JScrollPane buildGrid() {
        ...
        Color[][] colors = {
            {UIHelper.TEAL_DARK, UIHelper.TEAL_LIGHT, UIHelper.TEAL},
    ...
    private JPanel buildCard(ProgramLatihan p, Color hdrColor, Color bgColor, Color valColor) {
        ...
        hdr.setBorder(new EmptyBorder(14, 14, 14, 14));
        ...
        for (int i = 0; i < Math.min(daftar.size(), 5); i++) {
            ...
            circle.setPreferredSize(new Dimension(18, 18));
