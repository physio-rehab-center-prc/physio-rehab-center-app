...
public class Main {
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            System.out.println("==============================================");
            System.out.println("   PhysioHub - Sistem Manajemen Fisioterapi  ");
            System.out.println("==============================================");
            ...
            System.out.println("  Terapis : rina@physiohub.com    / terapis123");
            System.out.println("  Pasien  : budi@email.com        / pasien123");
            System.out.println("==============================================");
            new LoginFrame();
        });
    }
